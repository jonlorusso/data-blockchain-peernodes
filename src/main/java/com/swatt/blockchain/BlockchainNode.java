...
/** BlockchainNode is the abstract wrapper corresponding to a specific Blockchain (such as Bitcoin, Etherium, etc)
 */
public abstract class BlockchainNode {
     ...
     */
    public abstract BlockchainNodeData getDataForInterval(long fromTime, long toTime) ; // Assume EPOCH times in millisecs

...
public class ChainNodeIngestor {
	...
	public void startIngestingBackwardInChain(final String blockHash) {
		...
		}, "IngestorThread-" + chainNode.getName());
    ...
    public static void main(String[] args) {
    	try {
    		String nodeName = (args.length > 0) ? args[0] : "BTC";
    		String firstBlockHash = (args.length > 1) ? args[1] : null;
	    	boolean ingestBlocksViaPreviousHash = true;
	    	
	    	long runTimeMillis = 5 * 60 * 1000;
	    	
	    	ChainNodeManagerConfig chainNodeManagerConfig = ChainNodeManagerConfig.getDefaultChainNodeManager();
	    	...
	    	ChainNode chainNode = chainNodeManager.getChainNode(nodeName);
	    	...
	    	if (chainNode != null) {
	    		...
	    		System.out.println("No ChainNode found for type: " + nodeName);
